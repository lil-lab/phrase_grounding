...
class Graph:
    ...
    def add_edge(self, start_panoid, end_panoid, heading):
        ...
        self.edges[(start_panoid, end_panoid)] = heading


class GraphLoader:
    def __init__(self):
        self.graph = Graph()
        self.node_file = "/home/nk654/projects/p-interactive-touchdown/p-interactive-touchdown/graph/nodes.txt"
        self.link_file = "/home/nk654/projects/p-interactive-touchdown/p-interactive-touchdown/graph/links.txt"
